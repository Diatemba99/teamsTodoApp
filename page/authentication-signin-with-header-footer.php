...
<!-- Mirrored from codervent.com/amdash/demo/vertical/authentication-signin-with-header-footer.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Feb 2022 15:16:08 GMT -->
<head>
	<!-- Required meta tags -->
	<meta charset="utf-8">
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-white rounded fixed-top rounded-0 shadow-sm">
				<div class="container-fluid">
					<a class="navbar-brand" href="#">
						<img src="./page/assets/images/logo-img.png" width="140" alt="" />
					</a>
							...
							<div class="card-body">
								<div class="border p-4 rounded">
									<div class="text-center">
										<h3 class="">Sign in</h3>
										<p>Don't have an account yet? <a href="authentication-signup-with-header-footer.php">Sign up here</a>
										</p>
									</div>
									<div class="d-grid">
