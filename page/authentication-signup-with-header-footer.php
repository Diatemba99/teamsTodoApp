...
<!-- Mirrored from codervent.com/amdash/demo/vertical/authentication-signup-with-header-footer.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Feb 2022 15:16:08 GMT -->
<head>
	<!-- Required meta tags -->
	<meta charset="utf-8">
							...
							<div class="card-body">
								<div class="border p-4 rounded">
									<div class="text-center">
										<h3 class="">Sign Up</h3>
										<p>Already have an account? <a href="authentication-signin-with-header-footer.php">Sign in here</a>
										</p>
									</div>
									<div class="d-grid">
